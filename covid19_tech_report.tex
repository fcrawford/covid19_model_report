...
Unaccounted force of infection biases estimates of transmission parameter $\beta$, and hence estimates of $R_0$, upwards. 
A recently published analysis is consistent with $R_0 = 3.3$ in Connecticut \citep{kaplan2020covid}. This suggests that about 30\% to 45\% of infection events early in the epidemic could be imported, which is a plausible proportion range. 
Estimates of $R_{eff}$ at later stages of the epidemic are less likely to be affected by this source of bias, since lockdown measures have probably resulted in very low rate of inter-state contacts.  

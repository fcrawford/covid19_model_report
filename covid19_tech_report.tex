...
Our model projections are tightly linked to the state reopening plans, showing potential dynamics of new infections, hospitalization and deaths through the end of Summer of 2020 as a function of contact rates increase following the lifting of lockdown restrictions. By calibrating model parameters to local data,...

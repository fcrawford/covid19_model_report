...
Figure \ref{fig:fit} shows calibrated projections of hospitalizations and deaths, with 95\% uncertainty intervals, under the low asymptomatic fraction scenario and observed data as dots.  Observed data points track with mean projections and largely fall within uncertainty intervals.  Calibration results under medium and high asymptomatic fraction scenarios demonstrate a similar fit to historical data.  Figures \ref{fig:slow_low} to \ref{fig:fast_high} show projections of under the three different scenarios with `slow' reopening. The projections show the assumed contact pattern, daily COVID-19 incidence, hospital census, deaths, proportion of cumulative incidence, and effective reproductive number, $R\textsubscript{eff}$.  Table \ref{tbl:posterior} reports means and 95\% credible intervals of marginal posterior distributions of model parameters under the three asymptomatic fraction scenarios.

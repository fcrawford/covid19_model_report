...
Sampling from the joint posterior distribution of $\btheta$ given in (\ref{eq:posterior}) is performed using Markov Chain Monte Carlo (MCMC). We implemented a Metropolis algorithm with random walk symmetric Gaussian proposals for $\btheta$ and independent uniform proposals for $\bL$. We ran the sampler for $200,000$ iterations and thinned the chain using every $10$-th iteration.
...
Our estimate of ``crude'' $R_0$ under the low asymptomatic fraction scenario is $4.95$ ($95\%$ CI: $4.46 - 5.46$), which is on the higher end of available estimates, but similar to one recent modeling study that estimated $R_0$ to be 5.9 in Louisiana and 5.2 in New York \citep{miller2020mobility}. Under the high asymptomatic fraction scenario, our estimate is 6.24 ($95\%$ CI: $5.45 - 7.12$). We believe that this over-estimates the true $R_0$ as we do not model infection importation events from New York City that likely made a substantial contribution to the force of infection early in the epidemic. 
...
\begin{table}[!htb]
	...
	\begin{tabular}{r|rrr|rrr|rrr}
		...
		\hline
			$q_Is$ & 0.064 & 0.043 & 0.086 & 0.048 & 0.025 & 0.072 & 0.029 & 0.015 & 0.043 \\ 
			$\beta$ & 1.33 & 1.19 & 1.50 & 1.52 & 1.32 & 1.75 & 1.96 & 1.61 & 2.31 \\ 
			$\gamma_H$ & 0.114 & 0.096 & 0.130 & 0.116 & 0.097 & 0.132 & 0.113 & 0.098 & 0.129 \\ 
			$\gamma_U$ & 0.072 & 0.054 & 0.088 & 0.072 & 0.053 & 0.089 & 0.071 & 0.051 & 0.089 \\ 
			$k_A$ & 0.39 & 0.30 & 0.48 & 0.40 & 0.30 & 0.48 & 0.39 & 0.31 & 0.49 \\ 
			$k_{I_S}$ & 0.69 & 0.60 & 0.79 & 0.69 & 0.60 & 0.79 & 0.71 & 0.61 & 0.80 \\ 
			$m_H$ & 0.210 & 0.185 & 0.233 & 0.208 & 0.184 & 0.232 & 0.212 & 0.189 & 0.232 \\ 
			$m_U$ & 0.314 & 0.251 & 0.394 & 0.316 & 0.251 & 0.387 & 0.317 & 0.248 & 0.388 \\ 
			$q_H$ & 0.58 & 0.52 & 0.63 & 0.58 & 0.53 & 0.63 & 0.58 & 0.53 & 0.62 \\ 
			$w\textsubscript{school}$ & 0.15 & 0.12 & 0.18 & 0.15 & 0.12 & 0.18 & 0.15 & 0.12 & 0.18 \\ 
			$w\textsubscript{lockdown}$ & 0.70 & 0.66 & 0.74 & 0.70 & 0.67 & 0.74 & 0.72 & 0.68 & 0.75 \\ 
			crude $R_0$ & 4.95 & 4.46 & 5.46 & 5.30 & 4.74 & 5.93 & 6.24 & 5.45 & 7.12 \\ 
			$R_\textsubscript{eff}$ on May 20, 2020 & 0.67 & 0.57 & 0.76 & 0.68 & 0.60 & 0.76 & 0.65 & 0.56 & 0.74 \\ 
			symptomatic CHR & 0.057 & 0.037 & 0.079 & 0.055 & 0.029 & 0.084 & 0.055 & 0.027 & 0.084 \\ 
			IHR & 0.037 & 0.024 & 0.051 & 0.028 & 0.015 & 0.042 & 0.017 & 0.008 & 0.025 \\ 
			symptomatic CFR & 0.025 & 0.016 & 0.035 & 0.024 & 0.013 & 0.036 & 0.025 & 0.012 & 0.038 \\ 
			IFR & 0.0161 & 0.0103 & 0.0224 & 0.0120 & 0.0063 & 0.0178 & 0.0074 & 0.0036 & 0.0113 \\ 
		\bottomrule 
	\end{tabular}
	\vspace{0.5em}

...
p(\btheta, \bL | h(t), d(t)) \propto p(\btheta) p(\bL)
							 \prod_{t = t_0}^T \left[ p\big(h(t)| H(t, L_0, L_H, \btheta)\big)
							         p\big(d(t)| D(t, L_0, L_D, \btheta)\big) \right]^{1/T},
\label{eq:posterior}
\end{equation}
...
\toprule
		...
		$q_{I_S}$ (low $q_A$) & 0.064 & 0.012 & 0.024 & 0.104 & 10\% of symptomatic infections \citep{verity2020estimates, bi2020epidemiology, salje2020estimating, lane2020country} \\[0.5em]
		...
		$\gamma_H$, $\gamma_{\bar{H}}$ & 1/10 & 0.015 & 0.06 & 0.14 & \citep{lane2020country, lewnard2020incidence, paranjpe2020clinical, gold2020characteristics}, data from Yale Hew Haven Hospital \\[0.5em]
		...
		$m_H$ & 0.2 & 0.015 & 0.155 & 0.245 & \citep{lane2020country, lewnard2020incidence, paranjpe2020clinical, petrilli2020factors, verity2020estimates, perez2020clinical, docherty2020features, CHAwebsite} \\[0.5em]

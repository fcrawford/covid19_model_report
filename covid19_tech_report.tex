...
Figure \ref{fig:slow_low} to \ref{fig:slow_high} summarize projections of under the three different scenarios with `slow' reopening. The projections include daily COVID-19 incidence, hospital census, deaths, proportion of cumulative incidents, and effective reproductive number, $R\textsubscript{eff}$. 

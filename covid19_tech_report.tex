...
\begin{abstract}
\comment{yes, this needs an abstract.}
\end{abstract}
...
\label{eq:lamprior}
\end{equation}
where $s_\lambda$ and $r_\lambda$ are shape and rate parameters of Gamma distribution. We use $s_\lambda = 4$ and $r_\lambda = 0.0002$.


\subsection{Posterior inference} 
% \subsection{Weighting of observed data} 
Posterior inference is performed with a weighted likelihood that assigns more weight on more recent observations. We let the weight function $z(t)$ take the following form, 
...
% }
% \subsection{Posterior inference} 
The model yields the following posterior distribution,
\begin{equation}

...
Our estimate of ``crude'' $R_0$ under the low asymptomatic fraction scenario is $4.95$ ($95\%$ CI: $4.46 - 5.46$), which is on the higher end of available estimates, but similar to modeling studies that estimated $R_0$ to be 5.9 in Louisiana and 5.2 in New York \citep{miller2020mobility}. Under the high asymptomatic fraction, our estimate is 6.2 ($95\%$ CI: $5.46 - 7.00$). We believe that this over-estimates the true $R_0$ as we do not model infection importation events from New York City that likely made a substantial contribution to the force of infection early in the epidemic. 

...
%\comments{The introduction should be focused on how we model covid-19 and what we want from a model of this type.  Emphasize that we want a simple tractable model for a large population. Emphasize what policymakers will do with the information model projections provide}

%\comments{Three part introduction:}
%\begin{enumerate}
%  \item We need models to support public health decision making, including reopening and surveillance
%  \item Model output can tell us about historical info (e.g. R0 before interventions), the effects of interventions (e.g. lockdown), and projections about the future under specified scenarios. 
%  \item Models need to balance parsimony and realism.  Need to be able to explain to policymakers ``what the assumptions are''. 
%  \item Many nation-wide models do not use local data, or make simplifying assumptions not appropriate for localities.  
%  \item In this paper, we introduce a county-structured transmission model ...
%\end{enumerate}

Epidemiological models of disease transmission play an important role in supporting public health decision-making. They can provide insights about the historical trends in the epidemic dynamics, i.e. estimates of the $R_0$ (basic reproductive number) or $R\textsubscript{eff}$ (effective reproductive number) that accounts for the effects of interventions intended to slow down transmission and depletion of susceptible individuals.
...
%Stay-at-home orders are effective in reducing epidemiological contact that can transmit COVID-19.
%Which states have implemented stay at home orders: 
%https://www.cnn.com/2020/03/23/us/coronavirus-which-states-stay-at-home-order-trnd/index.html
%https://www.nytimes.com/interactive/2020/us/coronavirus-stay-at-home-order.html

%Stay-at-home orders are effective in reducing epidemiological contact that can transmit COVID-19. \citep{peak2020modeling}
%[Evidence on impact/effectiveness of stay at home orders]
%Lockdown in Wuhan (see refs in \citet{wells2020impact, tian2020investigation, kupferschmidt2020can})
%travel and border control measures \citep{wells2020impact}
%The travel quarantine of Wuhan delayed the overall epidemic progression by only 3 to 5 days in Mainland China, but has a more marked effect at the international scale \citep{chinazzi2020effect}. 
%Use real-time mobility data from Wuhan and detailed case data including travel history to elucidate the role of case importation on transmission in cities across China and ascertain the impact of control measures \citep{kraemer2020effect}.
%Effect of duration of measures \citep{prem2020effect}.
%A data-driven SEIQR model study in China. \citep{zhang2020impact}.
%Modeling in Singapore \citep{koo2020interventions}.
%Effectiveness and cost-effectiveness \citep{wang2020effectiveness}.

% contact tracing: ferretti2020quantifying
% other possibly related refs: niu2020deciphering, niehus2020using, prem2020age-structured, lewnard2020scientific, lin2020which.
...
Table \ref{table:params} provides a list of model parameters and their definitions. \comments{Seems missing $q_{HD}$ here which is in the next table?}
...
where $\beta_0$ is a value of transmission parameters in the absence of any interventions, $\iota\textsubscript{school}(t)$ is the size of contact reduction effect of school closure, and $\iota\textsubscript{lockdown} (t)$ is a size of contact reduction effect of lockdown that is independent of school closure effect. $\iota\textsubscript{school}(t)$ and $\iota\textsubscript{lockdown} (t)$ are zero when these interventions are not in effect, and can either have a constant or time-varying effect when interventions are in effect. 

Based on the known dates of school closure and lockdown orders, and assuming that these effects are constant over time once they reach their maximum levels, we calibrate the values of these effects to observed data. To project epidemic dynamics into the future, we replace  $\iota\textsubscript{lockdown} (t)$ with a function representing post-lockdown lifting distancing effect, which is unknown, but is assumed to be lower than the lockdown effect. 
